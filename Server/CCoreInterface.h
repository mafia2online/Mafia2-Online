...
public:
	...
	virtual	CNetworkPlayerManager			* GetPlayerManager				( void ) = 0;
	virtual	CNetworkVehicleManager			* GetVehicleManager				( void ) = 0;
	virtual	CNetworkBlipManager				* GetBlipManager				( void ) = 0;
